...
class CodeReview {
    ...
    owner;
    pull_number;
    base_a; // persiste a diferença entre o código do base e branch_a
    base_b; // persiste a diferença entre o código do base e branch_b
    base_merge; // persiste a diferença entre o código do base o merge do branch_a e branch_b 
    branch_a; //nome do branch a
    branch_b; // nome do branch b
